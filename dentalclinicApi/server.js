...
app.get('/', function (req, res) {
    return res.send({ error: ture, message: 'Test DentalClinic Booking web API' })
});
...
var dbConn = mysql.createConnection({
    ...
    user: 'root',
    password: '',
    database: 'bookingdental'
});

dbConn.connect();

app.get('/alldentalsbooking', function (req,res){
...
app.post('/booking', function (req,res){
    ...
    dbConn.query("INSERT INTO booking SET ?", dental, function (error, results, fields){
        if (error) throw error;
        return res.send(results);
    });
});
